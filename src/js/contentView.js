...
/*
    * `uioPlus.contentView` is a type of view component which extends the typical viewComponent facilities for
    ...
    * can.
    */
fluid.defaults("uioPlus.contentView", {
    ...
    invokers: {
        locateInContent: {
            funcName: "uioPlus.contentView.locateInContent",
            args: ["{that}", "{arguments}.0"]
        },
        locateOutOfContent: {
            funcName: "uioPlus.contentView.locateOutOfContent",
 ...
 *                 returned.
 */
uioPlus.contentView.findFirstSelector = function (locate, selectorNames, deflt) {
 ...
 * container.
 *
 * @param {Component} that - an instance of `uioPlus.contentView`
 ...
 */
uioPlus.contentView.locateInContent = function (that, selectorName) {
 ...
 */
uioPlus.contentView.locateOutOfContent = function (that, selectorName) {
