...
fluid.defaults("uioPlus.tests.contentView", {
    gradeNames: ["uioPlus.contentView"],
    selectors: {
        toFind: "span"
    }
});

uioPlus.tests.contentView.asssertSelection = function (that, prefix, selection, selectorName, expected) {
    expected = $(expected);
...
uioPlus.tests.contentView.assertSearch = function (that, prefix, method, expected) {
    var selection = that[method]("toFind");
    uioPlus.tests.contentView.asssertSelection(that, prefix + " - " + method, selection, "toFind", expected);
};

fluid.defaults("uioPlus.tests.contentView.check", {
    gradeNames: "fluid.test.sequenceElement",
    sequence: [{
        func: "uioPlus.tests.contentView.asssertSelection",
        args: [
            "{contentView}",
        ...
        func: "uioPlus.tests.contentView.assertSearch",
        args: [
            "{contentView}",
            "{testCaseHolder}.options.testOpts.prefix",
            "locateInContent",
...
fluid.defaults("uioPlus.tests.contentViewArticleTests", {
    ...
    components: {
        contentView: {
            type: "uioPlus.tests.contentView",
